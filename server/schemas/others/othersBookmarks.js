...
const othersBookmarksSchema = new mongoose.Schema({
    file_id:String,
    email:String,
    year:String,
    semester:String,
...
const OthersBookmarksModel = mongoose.model("othersbookmarks", othersBookmarksSchema);
module.exports = OthersBookmarksModel;