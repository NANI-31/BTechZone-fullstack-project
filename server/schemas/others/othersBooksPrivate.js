...
const othersBooksPrivateSchema = new mongoose.Schema({
    file_id:String,
    email:String,
    classified:String,
    year:String,
...
const OthersBooksPrivateModel = mongoose.model("othersbooksprivate", othersBooksPrivateSchema);
module.exports = OthersBooksPrivateModel;