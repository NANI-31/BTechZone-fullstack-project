...
const othersBooksRecentSchema = new mongoose.Schema({
    file_id:String,
    email:String,
    classified:String,
    year:String,
...
const OthersBooksRecentModel = mongoose.model("othersbooksrecent", othersBooksRecentSchema);
module.exports = OthersBooksRecentModel;