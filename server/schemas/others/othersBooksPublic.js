...
const othersBooksPublicSchema = new mongoose.Schema({
    file_id:String,
    email:String,
    classified:String,
    year:String,
...
const OthersBooksPublicModel = mongoose.model("othersbookspublic", othersBooksPublicSchema);
module.exports = OthersBooksPublicModel;