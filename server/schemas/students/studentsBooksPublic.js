...
const studentsBooksPublicSchema = new mongoose.Schema({
    file_id:String,
    email:String,
    classified:String,
    year:String,
...
const StudentsBooksPublicModel = mongoose.model("studentsbookspublic", studentsBooksPublicSchema);
module.exports = StudentsBooksPublicModel;