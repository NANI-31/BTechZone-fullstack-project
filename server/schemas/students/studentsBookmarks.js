...
const studentsBookmarksSchema = new mongoose.Schema({
    file_id:String,
    email_org:String,
    email_you:String,
    year:String,
...
const StudentsBookmarksModel = mongoose.model("studentsbookmarks", studentsBookmarksSchema);
module.exports = StudentsBookmarksModel;