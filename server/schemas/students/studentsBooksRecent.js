...
const studentsBooksRecentSchema = new mongoose.Schema({
  file_id: String,
  email: String,
  classified: String,
  year: String,
...
const StudentsBooksRecentModel = mongoose.model("studentsbooksrecent", studentsBooksRecentSchema);
module.exports = StudentsBooksRecentModel;