...
const teachersBookmarksSchema = new mongoose.Schema({
    file_id:String,
    email:String,
    year:String,
    semester:String,
...
const TeachersBookmarksModel = mongoose.model("teachersbookmarks", teachersBookmarksSchema);
module.exports = TeachersBookmarksModel;