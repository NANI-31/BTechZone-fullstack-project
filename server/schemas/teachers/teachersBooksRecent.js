...
const teachersBooksRecentSchema = new mongoose.Schema({
    file_id:String,
    email:String,
    classified:String,
    year:String,
...
const TeachersBooksRecentModel = mongoose.model("teachersbooksrecent", teachersBooksRecentSchema);
module.exports = TeachersBooksRecentModel;