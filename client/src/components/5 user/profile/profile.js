        ...
        <div className='profile-body'>
            ...
            <div className='profile-box'>
                ...
                <div className='profile-nav-links'>
                    <ul>
                        <li className={activeTab === 'Personal' ? 'profile-link profile-active' : 'profile-link'}
                            onClick={() => handleTabChange('Personal')}>Personal</li>
                        <li className={activeTab === 'Change' ? 'profile-link profile-active' : 'profile-link'}
                            onClick={() => handleTabChange('Change')}>Change</li>
                        <li className={activeTab === 'Account' ? 'profile-link profile-active' : 'profile-link'}
                            onClick={() => handleTabChange('Account')}>Account</li>
                        <li className={activeTab === 'Delete' ? 'profile-link profile-active' : 'profile-link'}
                            onClick={() => handleTabChange('Delete')}>Delete</li>
                    </ul>
                </div>
                        ...
                        <div className='profile-col'>
                            <div className='profile-col1'>
                                ...
                                <div className="profile-input-box b1">
                                    ...
                                    <label>E-mail</label><i className="fa-solid fa-envelope"></i>
                                </div>
                                <div className="profile-input-box b1">
                                    <input type="text" name="username" readOnly value={user?.phoneno || ''} />
                                    <label>Phone</label><i className="fa-solid fa-phone"></i>
                                </div>
                    ...
                    <form method='post' onSubmit={profilehandleChange}>
                        <div className='profile-col'>
                            <div className='profile-col1'>
                                ...
                                <div className="profile-input-box-change b1">
                                    <input type="tel" name="username" placeholder={user?.phoneno || ''}
                        ...
                        <div className="profile-signup-ib1">
                            <button className="profile-signup-btn" type="submit" name="submit">change</button>
                        </div>
                    </form>
                </div>
                <div className={activeTab === 'Account' ? 'profile-values-box pofile-show-active' : 'profile-values-box'}>
                    ...
                    <div className='profile-account-col'>
                            ...
                            <form method='post' onSubmit={profilemailchange}>
                                <div className='profile-email-change'>
                                    <div className="profile-input-box-account b1">
                                        <input type="text" name="username" readOnly value={user?.email || ''}
                                        />
                                        <label>Email</label><i className="fa-solid fa-envelope"></i>
                                    </div>
                                    <div className="profile-input-box-account b1">
                                        <input type="text" name="username" placeholder='Enter old E-mail'
                        ...
                        <div className='profile-col1'>
                            <form
                                onSubmit={profilepasschange}
                            >
                                <div className='profile-password-change'>
                                    <div className="profile-input-box-account b1">
                                        <input type={inputTypes.input1} name="username" placeholder='Enter old Password'
                                    ...
                                    <div className="profile-input-box-account b1">
                                        <input type={inputTypes.input2} name="username" placeholder='Enter old Password'
                    ...
                    <div className='profile-account-col'>
                        <div className='profile-col1'>
                            <form method='post' onSubmit={profilemailchange}>
                                ...
                                <div className="profile-signup-ib1">
                                    <button className="profile-signup-btn" type="submit" name="submit">Delete</button>
                                </div>
                            </form>
