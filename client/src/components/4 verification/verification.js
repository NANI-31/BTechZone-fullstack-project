...
function Verification() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.log(person)
            await axios.post('http://localhost:5000/signups/verification', { otpcode, name, email, password, phoneno, selectedYear, selectedSemester, selectedBranch, person, randomCode })
                .then(response => {
