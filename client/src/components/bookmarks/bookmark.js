            ...
            <div className='bookmarks-container'>
                ...
                <div className='bookmarks-nav-links'>
                    <ul className='bookmarks-ul'>
                        <li className={activeTab === 'student' ? 'bookmarks-link bookmarks-link-active' : 'bookmarks-link '}
                            onClick={() => handleTabChange('student')}>Student</li>
                        <li className={activeTab === 'teacher' ? 'bookmarks-link bookmarks-link-active' : 'bookmarks-link '}
                            onClick={() => handleTabChange('teacher')}>Teacher</li>
                        <li className={activeTab === 'other' ? 'bookmarks-link bookmarks-link-active' : 'bookmarks-link '}
                            onClick={() => handleTabChange('other')}>Other</li>
